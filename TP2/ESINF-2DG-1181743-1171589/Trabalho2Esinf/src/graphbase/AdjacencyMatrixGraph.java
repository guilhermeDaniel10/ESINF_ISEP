...
public class AdjacencyMatrixGraph<V, E> implements BasicGraph<V, E>, Cloneable {
    ...
    public Iterable<V> directConnections(V vertex) {
        int indexVertex = this.vertices.indexOf(vertex);
        LinkedList<V> lstOutgoingVertex = new LinkedList<>();
        for (V vertice : vertices) {
            int indexVertice = this.vertices.indexOf(vertice);
            if (this.edgeMatrix[indexVertex][indexVertice] != null) {
                lstOutgoingVertex.add(vertice);
            }
        }
        return lstOutgoingVertex;
    }
    ...
    public Iterable<E> outgoingEdges(V vertex) {
        LinkedList<V> lstAdjVertices = (LinkedList<V>) directConnections(vertex);
        LinkedList<E> lstOutgoingEdges = new LinkedList<>();
        int indexVertex = this.vertices.indexOf(vertex);
        for (V AdjVertice : lstAdjVertices) {
            int indexAdjVertice = this.vertices.indexOf(AdjVertice);
            lstOutgoingEdges.add(this.edgeMatrix[indexVertex][indexAdjVertice]);
        }
